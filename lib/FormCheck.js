...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props, ["id", "bsPrefix", "inline", "disabled", "isValid", "isInvalid", "feedback", "inputRef", "className", "style", "title", "type", "label", "children"]);
    ...
    return _react.default.createElement(_FormContext.default.Transform, {
      ...
      style: style,
      className: (0, _classnames.default)(className, bsPrefix, inline && bsPrefix + "-inline")
